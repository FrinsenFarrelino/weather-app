  ...
  <div class="h-full md:w-2/3">
    <div class="h-full pt-4 pb-2">
      ...
      <div class="flex flex-wrap justify-center items text-center">
        <div class="bg-green-200 w-36 h-36 md:w-[135px] md:h-[135px] lg:w-36 lg:h-36 mx-3 my-3 lg:mx-7 rounded-2xl flex py-4 px-4 md:py-3 md:px-3 lg:py-4 lg:px-4">
        ...
        <div class="bg-violet-300 w-36 h-36 md:w-[135px] md:h-[135px] lg:w-36 lg:h-36 mx-3 my-3 lg:mx-7 rounded-2xl flex py-4 px-4 md:py-3 md:px-3 lg:py-4 lg:px-4">
          <div class="text-center w-full flex flex-col justify-between">
            <div>
        ...
        <div class="bg-yellow-200 w-36 h-36 md:w-[135px] md:h-[135px] lg:w-36 lg:h-36 mx-3 my-3 lg:mx-7 rounded-2xl flex py-4 px-4 md:py-3 md:px-3 lg:py-4 lg:px-4">
          <div class="text-center w-full flex flex-col justify-between">
            <div>
        ...
        <div class="bg-slate-200 w-36 h-36 md:w-[135px] md:h-[135px] lg:w-36 lg:h-36 mx-3 my-3 lg:mx-7 rounded-2xl flex py-4 px-4 md:py-3 md:px-3 lg:py-4 lg:px-4">
          <div class="text-center w-full flex flex-col justify-between">
            <div>
        ...
        <div class="bg-orange-200 w-36 h-36 md:w-[135px] md:h-[135px] lg:w-36 lg:h-36 mx-3 my-3 lg:mx-7 rounded-2xl flex py-4 px-4 md:py-3 md:px-3 lg:py-4 lg:px-4">
          <div class="text-center w-full flex flex-col justify-between">
            <div>
