...
<div class="md:flex h-full">
  <div class="bg-dark-blue pb-10 px-7 text-white md:w-1/3 flex flex-col justify-between">
    ...
    <div class="mt-4 flex justify-center">
      <img src="//cdn.weatherapi.com/weather/64x64/day/116.png" width="80" alt="">
    </div>
    ...
    <div class="mt-8">
      ...
      <div class="flex justify-center">
        <p class="text-8xl font-semibold">33°C</p>
      </div>
    </div>
    ...
    <div class="mt-10">
      ...
      <div class="flex justify-between">
        ...
        <div>
          ...
          <p class="text-end">106.85</p>
        </div>
      </div>
    </div>
  
    <div class="flex justify-center text-black font-semibold">
      <div class="mt-8 w-72 h-24 bg-white rounded-2xl">
  ...
  <div class="h-full md:w-2/3">
    ...
    <div class="h-full pb-2 px-7 flex justify-center">
      <div class="flex overflow-x-auto scrolling-touch">
        <div class="flex-none w-20 h-28 md:h-36 bg-black rounded-lg mr-3 my-3"></div>
        <div class="flex-none w-20 h-28 md:h-36 bg-black rounded-lg mr-3 my-3"></div>
        <div class="flex-none w-20 h-28 md:h-36 bg-black rounded-lg mr-3 my-3"></div>
        <div class="flex-none w-20 h-28 md:h-36 bg-black rounded-lg mr-3 my-3"></div>
        <div class="flex-none w-20 h-28 md:h-36 bg-black rounded-lg mr-3 my-3"></div>
    ...
    <div class="h-full pt-4 pb-2 px-7">
      ...
      <div class="flex overflow-x-auto scrolling-touch">
        <div class="flex-none w-20 h-28 bg-black rounded-lg mr-3 my-3"></div>
        <div class="flex-none w-20 h-28 bg-black rounded-lg mr-3 my-3"></div>
        <div class="flex-none w-20 h-28 bg-black rounded-lg mr-3 my-3"></div>
        <div class="flex-none w-20 h-28 bg-black rounded-lg mr-3 my-3"></div>
        <div class="flex-none w-20 h-28 bg-black rounded-lg mr-3 my-3"></div>
    ...
    <div class="h-full pt-4 pb-2">
      ...
      <div class="flex flex-wrap justify-center items text-center">
        <div class="bg-slate-300 w-36 h-36 md:w-[135px] md:h-[135px] lg:w-36 lg:h-36 mx-3 my-3 lg:mx-7 rounded-2xl flex py-4 px-4 md:py-3 md:px-3 lg:py-4 lg:px-4">
          <div class="text-center w-full flex flex-col justify-between">
            <div>
              <p class="font-semibold">UV Index</p>
            </div>
            <div>
              <p class="text-5xl font-semibold">4</p>
            </div>
            <div>
              <p class="text-xs">Moderate</p>
            </div>
          </div>
        </div>
        <div class="bg-slate-300 w-36 h-36 md:w-[135px] md:h-[135px] lg:w-36 lg:h-36 mx-3 my-3 lg:mx-7 rounded-2xl flex py-4 px-4 md:py-3 md:px-3 lg:py-4 lg:px-4">
          <div class="text-center w-full flex flex-col justify-between">
            ...
            <div class="flex justify-center items-end">
              <p class="text-5xl font-semibold">13</p>
              <p>km/h</p>
            </div>
            <div class="flex justify-center">
        ...
        <div class="bg-slate-300 w-36 h-36 md:w-[135px] md:h-[135px] lg:w-36 lg:h-36 mx-3 my-3 lg:mx-7 rounded-2xl flex py-4 px-4 md:py-3 md:px-3 lg:py-4 lg:px-4">
          <div class="text-center w-full flex flex-col justify-between">
            ...
            <div class="flex items-end justify-center">
              <p class="text-5xl font-semibold">70</p>
              <p>%</p>
            </div>
            <div>
              <p class="text-xs">Too Humid</p>
            </div>
          </div>
        </div>
        <div class="bg-slate-300 w-36 h-36 md:w-[135px] md:h-[135px] lg:w-36 lg:h-36 mx-3 my-3 lg:mx-7 rounded-2xl flex py-4 px-4 md:py-3 md:px-3 lg:py-4 lg:px-4">
          <div class="text-center w-full flex flex-col justify-between">
            ...
            <div class="flex items-end justify-center">
              <p class="text-7xl font-semibold">32</p>
              <p>°C</p>
            </div>
          </div>
        </div>
